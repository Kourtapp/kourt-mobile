...
const ParkingIcon = ({ size = 20, color = '#000' }: { size?: number; color?: string }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Text style={{ fontSize: size * 0.8, fontWeight: 'bold', color }}>P</Text>
  </Svg>
);
...
const SportIcon = ({ size = 20, color = '#000' }: { size?: number; color?: string }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Circle cx="12" cy="12" r="10" stroke={color} strokeWidth="2" />
    <Path d="M12 2a10 10 0 0110 10" stroke={color} strokeWidth="2" />
              ...
              <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8 }}>
                {SPORTS.map((sport) => {
                  ...
                  return (
                    ...
                    >
                      <SportIcon size={16} color={isSelected ? '#FFFFFF' : '#000'} />
                      <Text style={{
                        fontSize: 14,
                        fontWeight: '500',
