...
import { ArrowLeft, Share, MoreHorizontal, ThumbsUp, MessageSquare, Share2, Trophy, User, Watch, Search, Heart, Activity, Check } from 'lucide-react-native';
                        ...
                        {[
                            ...
                            <View key={i} className="mb-4 last:mb-0">
                                ...
                                <View className="h-3 bg-gray-100 rounded-full overflow-hidden">
                                    <View className={`h-full rounded-full ${shot.color}`} style={{ width: shot.w }} />
                                </View>
                            </View>
                        ))}
                    </View>
                    ...
                    <View className="mx-5 mb-20">
                        ...
                        <View className="flex-row gap-3">
                            <View className="flex-1 bg-orange-50 border border-orange-100 p-4 rounded-2xl items-center">
                                <Flame size={24} color="#ea580c" className="mb-2" /> // Replaced Fire with Flame
