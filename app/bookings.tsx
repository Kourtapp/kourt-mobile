...
export default function BookingsScreen() {
  ...
  const renderBooking = ({ item }: { item: BookingItem }) => {
    const sport = item.court?.sport_type || 'beach-tennis';
            ...
            <View className="flex-1 ml-4">
              ...
              <View className="flex-row items-center mt-3 gap-4">
                ...
                <View className="flex-row items-center">
                  ...
                  <Text className="ml-1 text-neutral-600 text-sm">
                    {item.start_time?.slice(0, 5)} ({item.duration_hours}h)
                  </Text>
                </View>
              </View>
              ...
              <View className="flex-row items-center mt-3">
                <View className="flex-1" />
                <Text className="font-bold text-black">R$ {item.total_price}</Text>
              </View>
            </View>
          </View>
        </Card>
